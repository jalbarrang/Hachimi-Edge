...
use crate::{
    core::{ext::Utf16StringExt, hachimi::AssetMetadata},
    il2cpp::{
...
type LoadAssetFn =
    extern "C" fn(this: *mut Il2CppObject, name: *mut Il2CppString, type_: *mut Il2CppObject) -> *mut Il2CppObject;
extern "C" fn LoadAsset_Internal(
...
pub fn LoadAsset_Internal_orig(
    this: *mut Il2CppObject,
    name: *mut Il2CppString,
    type_: *mut Il2CppObject,
) -> *mut Il2CppObject {
...
type LoadAssetAsyncFn =
    extern "C" fn(this: *mut Il2CppObject, name: *mut Il2CppString, type_: *mut Il2CppObject) -> *mut Il2CppObject;
extern "C" fn LoadAssetAsync_Internal(
    this: *mut Il2CppObject,
    name: *mut Il2CppString,
    type_: *mut Il2CppObject,
) -> *mut Il2CppObject {
...
extern "C" fn LoadFromFile_Internal(path: *mut Il2CppString, crc: u32, offset: u64) -> *mut Il2CppObject {
    ...
    if !bundle.is_null() {
        BUNDLE_PATHS
            ...
            .insert(bundle as usize, GCHandle::new(path as _, false));
    }
    bundle
}
...
extern "C" fn Unload(this: *mut Il2CppObject, unload_all_loaded_objects: bool) {
    BUNDLE_PATHS.lock().expect("lock poisoned").remove(&(this as usize));
...
pub fn init(_UnityEngine_AssetBundleModule: *const Il2CppImage) {
    ...
    let LoadAsset_Internal_addr =
        il2cpp_resolve_icall(c"UnityEngine.AssetBundle::LoadAsset_Internal(System.String,System.Type)".as_ptr());
    let LoadAssetAsync_Internal_addr =
        il2cpp_resolve_icall(c"UnityEngine.AssetBundle::LoadAssetAsync_Internal(System.String,System.Type)".as_ptr());
    ...
    let Unload_addr = il2cpp_resolve_icall(c"UnityEngine.AssetBundle::Unload(System.Boolean)".as_ptr());
