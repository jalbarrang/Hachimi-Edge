...
#![allow(
    ...
    dead_code,
    clippy::useless_transmute,       // bindgen generates u32→u32 transmutes for bitfield accessors
    clippy::as_underscore,           // bindgen uses `as _` extensively
    clippy::undocumented_unsafe_blocks, // bindgen-generated unsafe blocks
...
pub const Il2CppRuntimeUnhandledExceptionPolicy_IL2CPP_UNHANDLED_POLICY_LEGACY: Il2CppRuntimeUnhandledExceptionPolicy =
    0;
pub const Il2CppRuntimeUnhandledExceptionPolicy_IL2CPP_UNHANDLED_POLICY_CURRENT: Il2CppRuntimeUnhandledExceptionPolicy =
    1;
...
pub struct Il2CppMemoryCallbacks {
    pub malloc_func: ::std::option::Option<unsafe extern "C" fn(size: usize) -> *mut ::std::os::raw::c_void>,
    pub aligned_malloc_func:
        ::std::option::Option<unsafe extern "C" fn(size: usize, alignment: usize) -> *mut ::std::os::raw::c_void>,
    pub free_func: ::std::option::Option<unsafe extern "C" fn(ptr: *mut ::std::os::raw::c_void)>,
    pub aligned_free_func: ::std::option::Option<unsafe extern "C" fn(ptr: *mut ::std::os::raw::c_void)>,
    pub calloc_func:
        ::std::option::Option<unsafe extern "C" fn(nmemb: usize, size: usize) -> *mut ::std::os::raw::c_void>,
    pub realloc_func: ::std::option::Option<
        unsafe extern "C" fn(ptr: *mut ::std::os::raw::c_void, size: usize) -> *mut ::std::os::raw::c_void,
    >,
...
pub struct Il2CppDebuggerTransport {
    ...
    pub connect: ::std::option::Option<unsafe extern "C" fn(address: *const ::std::os::raw::c_char)>,
    ...
    pub send: ::std::option::Option<
        unsafe extern "C" fn(buf: *mut ::std::os::raw::c_void, len: ::std::os::raw::c_int) -> ::std::os::raw::c_int,
    >,
...
pub type Il2CppProfileMethodFunc =
    ::std::option::Option<unsafe extern "C" fn(prof: *mut Il2CppProfiler, method: *const MethodInfo)>;
pub type Il2CppProfileAllocFunc = ::std::option::Option<
    unsafe extern "C" fn(prof: *mut Il2CppProfiler, obj: *mut Il2CppObject, klass: *mut Il2CppClass),
>;
pub type Il2CppProfileGCFunc = ::std::option::Option<
    unsafe extern "C" fn(prof: *mut Il2CppProfiler, event: Il2CppGCEvent, generation: ::std::os::raw::c_int),
>;
...
pub type Il2CppProfileFileIOFunc = ::std::option::Option<
    unsafe extern "C" fn(prof: *mut Il2CppProfiler, kind: Il2CppProfileFileIOKind, count: ::std::os::raw::c_int),
>;
pub type Il2CppProfileThreadFunc =
    ::std::option::Option<unsafe extern "C" fn(prof: *mut Il2CppProfiler, tid: ::std::os::raw::c_ulong)>;
pub type Il2CppSetFindPlugInCallback =
    ::std::option::Option<unsafe extern "C" fn(arg1: *const Il2CppNativeChar) -> *const Il2CppNativeChar>;
pub type Il2CppLogCallback = ::std::option::Option<unsafe extern "C" fn(arg1: *const ::std::os::raw::c_char)>;
pub type Il2CppBacktraceFunc =
    ::std::option::Option<unsafe extern "C" fn(buffer: *mut Il2CppMethodPointer, maxSize: usize) -> usize>;
pub type il2cpp_array_size_t = usize;
pub type Il2CppAndroidUpStateFunc =
    ::std::option::Option<unsafe extern "C" fn(ifName: *const ::std::os::raw::c_char, is_up: *mut u8) -> u8>;
pub type SynchronizationContextCallback = ::std::option::Option<unsafe extern "C" fn(arg: isize)>;
pub type CultureInfoChangedCallback = ::std::option::Option<unsafe extern "C" fn(arg: *const Il2CppChar)>;
...
pub struct Il2CppVariant__bindgen_ty_1___tagVARIANT__bindgen_ty_1 {
    ...
    pub n4: __BindgenUnionField<Il2CppVariant__bindgen_ty_1___tagVARIANT__bindgen_ty_1___tagBRECORD>,
...
pub type CreateCCWFunc = ::std::option::Option<unsafe extern "C" fn(obj: *mut Il2CppObject) -> *mut Il2CppIUnknown>;
#[repr(C)]
#[derive(Debug)]
...
impl Il2CppClass {
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            // SAFETY: Transmute required for IL2CPP type conversion
            let initialized_and_no_error: u8 = unsafe { ::std::mem::transmute(initialized_and_no_error) };
        ...
        __bindgen_bitfield_unit.set(12usize, 1u8, {
            // SAFETY: Transmute required for IL2CPP type conversion
            let is_import_or_windows_runtime: u8 = unsafe { ::std::mem::transmute(is_import_or_windows_runtime) };
...
pub const Il2CppResourceLocation_IL2CPP_RESOURCE_LOCATION_ANOTHER_ASSEMBLY: Il2CppResourceLocation = 2;
...
impl Il2CppDouble {
    ...
    #[inline]
    pub fn new_bitfield_1(mantLo: u32, mantHi: u32, exp: u32, sign: u32) -> __BindgenBitfieldUnit<[u8; 8usize]> {
