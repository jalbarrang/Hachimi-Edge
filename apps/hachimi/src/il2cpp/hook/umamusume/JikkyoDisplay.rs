use crate::{
    core::{
        utils::{wrap_text, wrap_text_il2cpp},
        Hachimi,
    },
    il2cpp::{
...
type PlayFn = extern "C" fn(
    ...
    jikkyou_text: *mut Il2CppString,
    jikkyou_voice_cmd: *mut Il2CppString,
    type_: i32,
    tension: i32,
    on_end: *mut Il2CppObject,
    is_cross_time_enable: bool,
);
extern "C" fn Play(
    this: *mut Il2CppObject,
    mut jikkyou_text: *mut Il2CppString,
    jikkyou_voice_cmd: *mut Il2CppString,
    type_: i32,
    tension: i32,
    on_end: *mut Il2CppObject,
